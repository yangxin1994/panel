...
class Component extends WebComponent {
   ...
   * @type {object}
   * @property {function} template - function transforming state object to virtual-dom tree (required)
   ...
   * @property {boolean} useShadowDom - whether to use Shadow DOM (default: false)
   * @property {string} css - component-specific Shadow DOM stylesheet (default: '')
   * @example
   * get config() {
   *   return {
