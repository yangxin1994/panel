...
class Component extends WebComponent {
  ...
  /**
   * Returns the reference to the panel parent of the given tag name. An error is thrown out if no
   * parent of such tag name is found.
   * @param {string} tagName - tag name of the parent to search for.
   * @example myWidget.findPanelParentByTagName('my-app');
   */
  findPanelParentByTagName(tagName) {
    for (let node = this; node; node = node.$panelParent) {
